...
jest.mock('@/components/ui/features/homePage/ProblemSection', () => 
  jest.fn(() => <section data-testid="problem-section">Problem Section</section>)
);

jest.mock('@/components/ui/features/homePage/SolutionSection', () => 
  jest.fn(() => <section data-testid="solution-section">Solution Section</section>)
);

jest.mock('@/components/ui/features/homePage/TargetAudience', () => 
  jest.fn(() => <section data-testid="target-audience">Target Audience</section>)
);

jest.mock('@/components/ui/features/homePage/FeaturesSection', () => 
  jest.fn(() => <section data-testid="features-section">Features Section</section>)
);
...
describe('<HomePage />', () => {
  ...
  it('renderiza todos los componentes hijos exactamente una vez', () => {
    ...
    mocks.forEach((componentName) => {
      expect(jest.requireMock(`@/components/ui/features/homePage/${componentName}`))
